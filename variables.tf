...
variable "ID_RSA_FILE_PATH" {
    ...
    nullable = false
    description = "The file path for private_ssh_key will be automatically generated by default. If it is changed, it must contain the relative path from git repo folders. Default value: \"ansible/id_rsa_abap_db2_std\"."
}
...
variable "ZONE" {
	type		= string
	description	= 	"The cloud zone where to deploy the solution. Sample value: \"eu-de-2\"."
	validation {
...
variable "sap_sid" {
	type		= string
	description =	"The SAP system ID identifies the entire SAP system. Default value: \"DB1\". "
	default		= "DB2"
	validation {
...
variable "sap_ascs_instance_number" {
	type		= string
	description ="Technical identifier for internal processes of ASCS. Default value: \"01\". "
	default		= "01"
	validation {
...
variable "sap_main_password" {
	type		= string
	sensitive = true
	description = 	"Common password for all users that are created during the installation. (Sensitive* value)."
	validation {
